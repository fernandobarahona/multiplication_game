...
func _ready():
	var _err1 = get_node("MenuContainer/GoToGameBtn").connect("pressed",self,"goto_scene",[_game_scene])
	var _err2 = get_node("MenuContainer/GoToSettingsBtn").connect("pressed",self,"goto_scene",[_config_menu_scene])
	var _err3 = get_node("MenuContainer/GoToLoginBtn").connect("pressed",self,"goto_scene",[_login_scene])
